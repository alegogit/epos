...
public class BaseRestTemplate extends RestTemplate implements
	...
	public BaseRestTemplate(boolean check) {
		super(check);
		initRestTemplate();
	}
	...
	private void initRestTemplate() {
		...
		doTimeoutRest();
		setInterceptors(getIntercept());
	}

	private List<ClientHttpRequestInterceptor> getIntercept() {
		List<ClientHttpRequestInterceptor> intercept = new ArrayList<ClientHttpRequestInterceptor>();
		intercept.add(this);
		return intercept;
	}

	private void doTimeoutRest() {
