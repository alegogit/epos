...
public class FontUtil {
    public static enum Font {
        ...
        @Getter private final String regularName;
        @Getter private final String boldName;
    ...
    private static final HashMap<Font,SoftReference<FontFamily>> fonts =
        new HashMap<Font,SoftReference<FontFamily>>();
    ...
    public static void applyFont(TextView view, FontFamily font) {
        ...
        if (tf == null) view.setTypeface(font.getRegular());
        else if (tf.isBold()) view.setTypeface(font.getBold());
        else view.setTypeface(font.getRegular());
    }
    ...
    private static class FontFamily {
        @Getter private final Typeface regular;
        @Getter private final Typeface bold;
