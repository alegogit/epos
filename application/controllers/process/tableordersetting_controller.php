...
class Tableordersetting_controller extends CI_Controller {
	
	function __construct()
	{
		parent::__construct();	
		$this->load->model('process/tableordersetting_model','process',TRUE);
      ...
      if (isset($data['p'])) {   
        switch ($data['p']){
          ...
          case 'delete':      
            ...
            $this->load->view('process/delete_tableorder',$data);
          break;
        }
      }
		}
