<div class="menu-toggle" style="box-shadow:none !important;">
  	<a href="#menu-toggle" class="" id="menu-toggle">
    <!--<span id="hand" class="glyphicon glyphicon-chevron-left"></span>-->
    <span id="hand" class="">&nbsp;</span>
	</a>
</div>
...
<div id="sidebar-wrapper">
  ...
  <div class="copyright"> 
  <div id="calendar" style="background-color:#fff;margin:5px;border-radius:5px;width:88%;padding:0;" class="responsive"></div>  
