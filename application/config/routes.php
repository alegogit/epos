...
$route['reports/payment'] = "reports/payment_controller";   
$route['reports/paymentview/(:any)'] = "reports/payment_controller/view";
$route['reports/paymentprint/(:any)'] = "reports/payment_controller/printing";
$route['reports/attendance'] = "reports/attendance_controller";   
$route['reports/attendanceview/(:any)'] = "reports/attendance_controller/view";
$route['reports/attendanceprint/(:any)'] = "reports/attendance_controller/printing";  
...
$route['reports/weekly'] = "reports/weekly_controller"; 
$route['reports/salesweekly/(:any)'] = "reports/weekly_controller/salesview";
$route['reports/reconweekly/(:any)'] = "reports/weekly_controller/reconview";
$route['reports/weeklysalesprint/(:any)'] = "reports/weekly_controller/salesprint";
$route['reports/weeklyreconprint/(:any)'] = "reports/weekly_controller/reconprint";  
$route['reports/monthly'] = "reports/monthly_controller"; 
$route['reports/salesmonthly/(:any)'] = "reports/monthly_controller/salesview";
$route['reports/attndmonthly/(:any)'] = "reports/monthly_controller/attndview";
$route['reports/monthlysalesprint/(:any)'] = "reports/monthly_controller/salesprint";
$route['reports/monthlyattndprint/(:any)'] = "reports/monthly_controller/attndprint"; 
