...
<form id="msform" class="form-horizontal" action="" role="form">
	<!-- progressbar -->
	<ul id="progressbar">
		<li class="active"><p>Select a Facility</p></li>
		<li><p>Confirmation</p></li>
	</ul>
	<!-- fieldsets -->
	<fieldset>
		<h2 class="fs-title">Select a Facility</h2>
		<h3 class="fs-subtitle">
            <div id="effect"></div>
              <!--email belum diisi.-->
        </h3>
        <div class="form-group">
          <label for="inputEmail" class="col-sm-3 control-label">Facility</label>
          <div class="col-sm-8">
            <select class="form-control">
              <option>-- Select --</option>
              <option>Badminton Court</option>
              <option>Tenis Court</option>
              <option>Community Room A</option>
              <option>Community Room B</option>
            </select>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" name="date" class="form-control datepicker" placeholder="" />
          </div>
        </div>
        <div class="form-group">
          <label for="inputEmail" class="col-sm-3 control-label">Time Period</label>
          <div class="col-sm-3">
            <select class="form-control">
              <option>08:00</option>
              <option>09:00</option>
          ...
          <label for="inputEmail" class="col-sm-1 control-label">To</label>
          <div class="col-sm-3">
            <select class="form-control">
              <option>08:00</option>
              <option>09:00</option>
